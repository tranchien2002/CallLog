...
(function(h) {
  ...
  function fb(a) {
    if (!m.__browser) {
      ...
      b.bBounding = c[0].getBoundingClientRect().width
        ? !0
        : !1;
      c.remove()
    }
  ...
  function B(a, b, c, d) {
    ...
    if (i === k)
      return a.iDrawError != e && null === j && (J(a, 0, "Requested unknown parameter " + (
        "function" == typeof f.mData
        ? "{function}"
        : "'" + f.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError = e),
      j;
...
- 1 != d && c === k && a.splice(d, 1)
  ...
  function sa(a, b, c) {
    ...
    r(a, null, "preXhr", [a, b]);
    a.fnServerData
      ? a.fnServerData.call(j, a.sAjaxSource, h.map(b, function(a, b) {
  ...
  function kb(a) {
    return a.bAjaxDataGet
      ? (a.iDraw++, C(a, !0), sa(a, tb(a), function(b) {
        ub(a, b)
      }), !1)
      : !0
  }
  ...
  function ob(a) {
    var b = a.oClasses,
      ...
      i = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on(
        "keyup.DT search.DT input.DT paste.DT cut.DT", g
        ? Na(f, g)
        : f).on("keypress.DT", function(a) {
        if (13 == a.keyCode)
          return !1
  ...
  function fa(a, b, c) {
    ...
    if ("ssp" != y(a)) {
      vb(
        a, b.sSearch, c, b.bEscapeRegex !== k
        ? !b.bEscapeRegex
        : b.bRegex,
      b.bSmart,
      b.bCaseInsensitive);
      ...
      for (b = 0; b < e.length; b++)
        wb(
          a, e[b].sSearch, b, e[b].bEscapeRegex !== k
          ? !e[b].bEscapeRegex
          : e[b].bRegex,
        e[b].bSmart,
    ...
    for (f = a.aoData.length; d < f; d++)
      if (h = a.aoData[d], !h._aFilterData) {
        ...
        for (g = b.length; e < g; e++)
          c = b[e],
          c.bSearchable
            ? (i = B(a, d, e, "filter"), l[c.sType] && (i = l[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString()))
            : i = "",
  ...
  function Cb(a, b) {
    var c = a.fnFormatNumber,
      ...
      g = -1 === e;
    return b.replace(/_START_/g, c.call(a, d)).replace(/_END_/g, c.call(a, a.fnDisplayEnd())).replace(/_MAX_/g, c.call(a, a.fnRecordsTotal())).replace(/_TOTAL_/g, c.call(a, f)).replace(/_PAGE_/g, c.call(
      a, g
      ? 1
      : Math.ceil(d / e))).replace(/_PAGES_/g, c.call(
      a, g
      ? 1
      : Math.ceil(f / e)))
  }
  ...
  function nb(a) {
    for (
      var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e
      ? d[0]
      : d,
    d = e
      ? d[1]
  ...
  function qb(a) {
    ...
    i = h("<div/>", {"class": f.sScrollWrapper}).append(h("<div/>", {"class": f.sScrollHead}).css({
      ...
      "top" === j
      ? g
      : null).append(b.children("thead"))))).append(h("<div/>", {"class": f.sScrollBody}).css({
      position: "relative",
      overflow: "auto",
      width: !d
        ? null
  ...
  function ka(a) {
    ...
    if (a.scrollBarVis !== K && a.scrollBarVis !== k)
      ...
      i[e] = d
        ...
        : "0px";
      u && (
        m[0].style.width = v(c), t[0].style.width = v(c), t[0].style[e] = d
        ? b + "px"
        : "0px");
    ...
    if ("ssp" != y(a) && 0 !== h.length) {
      ...
      g === h.length
        ? i.sort(function(a, b) {
          ...
          for (g = 0; g < i; g++)
            if (
              j = h[g], c = k[j.col], e = m[j.col], c = c < e
              ? -1
              : c > e
                ? 1
                : 0,
    ...
    for (var b, c, d = a.aoColumns, e = V(a), a = a.oLanguage.oAria, f = 0, g = d.length; f < g; f++) {
      ...
      c.bSortable && (
        ...
        ? (i.setAttribute(
          ...
          ? "ascending"
          : "descending"), c = j[e[0].index + 1] || j[0])
        : c = j[0],
      b += "asc" === c
        ? a.sSortAscending
        : a.sSortDescending);
    ...
    this.each(function() {
      ...
      if ("table" != this.nodeName.toLowerCase())
        ...
        null !== g.iDeferLoading && (
          p.bDeferLoading = !0, e = h.isArray(g.iDeferLoading), p._iRecordsDisplay = e
          ? g.iDeferLoading[0]
          : g.iDeferLoading,
        p._iRecordsTotal = e
          ? g.iDeferLoading[1]
        ...
        var T = p.oFeatures,
          ...
          g.bStateSave
            ? (T.bStateSave = !0, z(p, "aoDrawCallback", xa, "state_save"), Ib(p, g, e))
            : e()
        }
      });
      b = null;
  ...
  iterator: function(a, b, c, d) {
    ...
    return e.length || d
      ? (a = new s(
        l, a
        ? e.concat.apply([], e)
        : e), b = a.selector, b.rows = u.rows, b.cols = u.cols, b.opts = u.opts, a)
      : this
  },
      ...
      f = function(a, b) {
        if (h.isArray(a) || a instanceof h)
          ...
          a.nodeName && "tr" === a.nodeName.toLowerCase()
            ? e.push(a)
            : (c = h("<tr><td/></tr>").addClass(b), h("td", c).addClass(b).html(a)[0].colSpan = aa(d), e.push(c[0]))
        };
    f(a, b);
        ...
        if (a === f) {
          ...
          b.removeClass(d.sSortAsc + " " + d.sSortDesc).addClass(
            ...
            : h[e] == "desc"
              ? d.sSortDesc
              : c.sSortingClass);
          b.find("span." + d.sSortIcon).removeClass(d.sSortJUIAsc + " " + d.sSortJUIDesc + " " + d.sSortJUI + " " + d.sSortJUIAscAllowed + " " + d.sSortJUIDescAllowed).addClass(
            h[e] == "asc"
            ? d.sSortJUIAsc
            : h[e] == "desc"
              ? d.sSortJUIDesc
