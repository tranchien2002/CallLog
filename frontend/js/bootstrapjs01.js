...
var bootstrap = function(t, e, n) {
  ...
  var s = function() {
    ...
    a = function() {
      ...
      return e(document).on(i.CLICK_DATA_API, {DISMISS: '[data-dismiss="alert"]'}.DISMISS, a._handleDismiss(new a)),
          ...
          f._slide = function(t, n) {
            ...
            _ && e(_).hasClass(u.ACTIVE))
              ...
              s.supportsTransitionEnd() && e(this._element).hasClass(u.SLIDE)
                ? (e(_).addClass(r), s.reflow(_), e(l).addClass(i), e(_).addClass(i), e(l).one(s.TRANSITION_END, function() {
      ...
      var t = "modal",
        ...
        u = function() {
          ...
          u._showElement = function(t) {
            ...
            i
              ? e(this._dialog).one(s.TRANSITION_END, o).emulateTransitionEnd(300)
              : o()
          },
        ...
        m = function() {
          ...
          m.hide = function(t) {
            ...
            r.isDefaultPrevented() || (
              e(i).removeClass(f.SHOW), "ontouchstart" in document.documentElement && e("body").children().off("mouseover", null, e.noop), this._activeTrigger[g.CLICK] = !1, this._activeTrigger[g.FOCUS] = !1, this._activeTrigger[g.HOVER] = !1, s.supportsTransitionEnd() && e(this.tip).hasClass(f.FADE)
          ...
          m._enter = function(t, n) {
            ...
            e(n.getTipElement()).hasClass(f.SHOW) || n._hoverState === u.SHOW
              ...
              : (
                clearTimeout(n._timeout), n._hoverState = u.SHOW, n.config.delay && n.config.delay.show
          ...
          m._leave = function(t, n) {
            ...
            n._isWithActiveTrigger() || (
              clearTimeout(n._timeout), n._hoverState = u.OUT, n.config.delay && n.config.delay.hide
              ? n._timeout = setTimeout(function() {
        ...
        u = function() {
          ...
          u._activate = function(t) {
            ...
            i.hasClass(l.DROPDOWN_ITEM)
              ...
              : (i.addClass(l.ACTIVE), i.parents(h.NAV_LIST_GROUP).prev(h.NAV_LINKS + ", " + h.LIST_ITEMS).addClass(l.ACTIVE), i.parents(h.NAV_LIST_GROUP).prev(h.NAV_ITEMS).children(h.NAV_LINKS).addClass(l.ACTIVE)),
      ...
      var t = e.fn.tab,
        ...
        a = function() {
          ...
          a._transitionComplete = function(t, n, r, a) {
            ...
            if (
              e(t).addClass(i.ACTIVE), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), r
